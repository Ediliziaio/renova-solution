  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        canonical="https://www.renovasolution.it/infissi/porte-portoni"
        ogImage="/images/confronto-finestre.jpg"
        schema={[
          serviceSchema('Porte Blindate e Portoni', 'Vendita e installazione porte blindate e portoni di sicurezza', 'https://www.renovasolution.it/infissi/porte-portoni'),
          faqSchema(faqItems)
        ]}
      />
      <TopBar />
